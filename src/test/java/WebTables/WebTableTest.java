...
public class WebTableTest extends Base {
	...
	public void webTablesTest() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("firstName")).sendKeys("Itachi");
		driver.findElement(By.id("lastName")).sendKeys("Uciha");
		...
		for (int i = 0; i < elements.size(); i++) {
			...
			if (a.equals("Itachi")) {
				...
				String salary = driver.findElement(By.xpath(baseXPath + "[3]")).getText();
				String age = driver.findElement(By.xpath(baseXPath + "[4]")).getText();

				Reporter.log("Firstname = " + firstname + ", Lastname = " + lastName + ", Salary = " + salary
						+ ", Age = " + age, true);
			}
		}
